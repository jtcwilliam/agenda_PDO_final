 ...
 */
 ...
 echo '    <center style="font-family: arial; font-size:2em"> <form action="index.php" method="post">
       <br>&nbsp;<br><input style="width: 900px; font-size:1em"  name="data" placeholder="  " value="'.(isset($_REQUEST['data'])?htmlspecialchars($_REQUEST['data']):'Digite aqui o Site ou a informação para o QR Code :)').'" /><br>&nbsp;
    ...
    echo '</select>&nbsp;
        <input type="submit" style="height: 40px; font-size: 0.8em" value="Clica aqui pra criar seu codigo qrCode! Paga nada não!"></form></center>';
